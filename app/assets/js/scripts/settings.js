        ...
        authAccountStr += `<div class="settingsAuthAccount" uuid="${acc.uuid}">
            ...
            <div class="settingsAuthAccountRight">
                ...
                <div class="settingsAuthAccountActions">
                    <button class="settingsAuthAccountSelect" ${selectedUUID === acc.uuid ? 'selected>Compte sélectionné &#10004;' : '>Sélectionner ce compte'}</button>
...
function populateReleaseNotes(){
    $.ajax({
        url: 'https://github.com/valkam08/NercoriaLauncher/releases.atom',
        success: (data) => {
        ...
        settingsAboutChangelogText.innerHTML = 'Impossible de charger les notes de mise à jour.'
    })
}
...
function populateSettingsUpdateInformation(data){
    if(data != null){
        ...
        if(process.platform === 'darwin'){
            settingsUpdateButtonStatus('Téléchargement depuis GitHub<span style="font-size: 10px;color: gray;text-shadow: none !important;">Fermer le launcher et lancer le fichier .dmg .</span>', false, () => {
